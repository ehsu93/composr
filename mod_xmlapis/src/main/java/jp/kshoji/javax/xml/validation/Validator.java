...
import jp.kshoji.javax.xml.transform.Result;
import jp.kshoji.javax.xml.transform.Source;
 ...
 * methods take a {@link javax.xml.transform.Source} instance, the <code>Source</code>
...
public abstract class Validator {
     ...
     * 
     * <p>
     * Derived classes must create {@link javax.xml.validation.Validator} objects that have
	 ...
	 * 
	 * <p>The reset <code>Validator</code> is not guaranteed to have the same {@link org.w3c.dom.ls.LSResourceResolver} or {@link org.xml.sax.ErrorHandler}
     ...
     * the {@link javax.xml.transform.Source}/{@link javax.xml.transform.Result} accepted.
     * 
     * <h4>{@link javax.xml.transform.Source}/{@link javax.xml.transform.Result} accepted:</h4>
     * <table border=1>
     * <thead>
     *  <tr>
     *   <td></td>
     ...
     * a <code>StreamSource</code>, or to validate one {@link javax.xml.transform.Source} into another kind of {@link javax.xml.transform.Result}, use the identity transformer
     ...
     * but none of them were fatal and the {@link org.xml.sax.ErrorHandler} didn't
     ...
     * 
     * @param result
     *      The {@link javax.xml.transform.Result} object that receives (possibly augmented)
     ...
     *      If the {@link javax.xml.transform.Result} type doesn't match the {@link javax.xml.transform.Source} type,
     ...
     * 
     * @see #validate(javax.xml.transform.Source)
     */
    ...
    /**
     * Gets the current {@link org.xml.sax.ErrorHandler} set to this {@link javax.xml.validation.Validator}.
     * 
     * @return
     ...
     * 
     * <p>
     * {@link javax.xml.validation.Validator} uses a {@link org.w3c.dom.ls.LSResourceResolver}
    ...
    /**
     * Gets the current {@link org.w3c.dom.ls.LSResourceResolver} set to this {@link javax.xml.validation.Validator}.
     * 
     * @return
     *      This method returns the object that was last set through
