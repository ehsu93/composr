...
public class DOMSource implements Source {
     ...
     * no DOM source is set using {@link #setNode(org.w3c.dom.Node node)} , then the
     * <code>Transformer</code> will
     * create an empty source {@link org.w3c.dom.Document} using
     * {@link javax.xml.parsers.DocumentBuilder#newDocument()}.</p>
     *
     * @see javax.xml.transform.Transformer#transform(javax.xml.transform.Source xmlSource, Result outputTarget)
     */
    public DOMSource() { }
