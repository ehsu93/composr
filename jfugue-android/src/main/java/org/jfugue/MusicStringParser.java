...
public final class MusicStringParser extends Parser
{
     ...
     * @see org.jfugue.JFugueDefinitions
     */
     ...
     * @throws org.jfugue.JFugueException if there is a problem parsing the string
     */
     ...
     * @throws org.jfugue.JFugueException if there is a problem parsing the element
     */
...
//        context.duration = (long)(ppw * context.decimalDuration) / 4000; 
     ...
     * @throws org.jfugue.JFugueException if there is a problem looking up bracketedString
     */
     ...
     * @throws org.jfugue.JFugueException if there is a problem getting a byte from the dictionary look-up
     */
     ...
     * @throws org.jfugue.JFugueException if there is a problem getting a long from the dictionary look-up
     */
     ...
     * @throws org.jfugue.JFugueException if there is a problem getting a int from the dictionary look-up
     */
     ...
     * @throws org.jfugue.JFugueException if there is a problem getting a double from the dictionary look-up
     */
