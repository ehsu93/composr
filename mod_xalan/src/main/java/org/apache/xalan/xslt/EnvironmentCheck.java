...
public class EnvironmentCheck
{
   ...
   * {@link #checkEnvironment(java.io.PrintWriter)}.</p>
   ...
   * @return true if your environment appears to have no major 
   * problems; false if potential environment problems found
   * @see #appendEnvironmentReport(org.w3c.dom.Node, org.w3c.dom.Document, java.util.Hashtable)
   ...
   * @see #writeEnvironmentReport(java.util.Hashtable)
   ...
   * @see #jarNames
   * @see #logFoundJars(java.util.Vector, String)
   * @see #appendFoundJars(org.w3c.dom.Node, org.w3c.dom.Document, java.util.Vector, String )
