...
public class Compiler extends OpMap
{
   ...
   *
   * @throws javax.xml.transform.TransformerException if there is a syntax or other error.
   * @xsl.usage advanced
   */
...
//      expr.setSourceLocator(m_locator);
   ...
   *
   * @throws javax.xml.transform.TransformerException if syntax or other error occurs.
   */
   ...
   *
   * @throws javax.xml.transform.TransformerException if a error occurs creating the Expression.
   */
...
private static final boolean DEBUG = false;
   ...
   *             may be null.
   *
   * @throws javax.xml.transform.TransformerException if the current ErrorListoner determines to
   *                              throw an exception.
   */
