...
//      return ((DOMSource) source).getNode();
   ...
   * base and urlString.
   *
   * @throws javax.xml.transform.TransformerException If the URL can not resolve to a node.
   */
   ...
   *
   * @throws javax.xml.transform.TransformerException if the Source argument can't be resolved to
   *         a node.
   */
   ...
   *
   * @throws javax.xml.transform.TransformerException if the source argument can not be resolved
   *         to a source node.
   */
   ...
   *
   * @throws javax.xml.transform.TransformerException if the reader can not be created.
   */
