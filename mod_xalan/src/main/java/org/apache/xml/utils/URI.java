...
public class URI implements Serializable
{
   ...
   *                  empty)
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if p_uriSpec violates any syntax
   *                                   rules
   */
   ...
   *                             null or empty)
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if p_scheme violates any
   *                                  syntax rules
   */
   ...
   *                   is null)
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if any of the parameters violates
   ...
   *                  is not null)
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if p_base is null and p_uriSpec
   ...
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if URI does not have a conformant
   *                                  scheme
   */
   ...
   * @param p_uriSpec the URI specification (cannot be null)
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if p_uriSpec violates syntax rules
   */
   ...
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if p_scheme is not a conformant
   *                                  scheme name
   */
   ...
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if p_userinfo contains invalid
   *                                  characters
   */
   ...
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if p_host is not a valid IP
   ...
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if p_port is not -1 and not a
   *                                  valid port number
   */
   ...
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if p_path contains invalid
   *                                  characters
   */
   ...
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if p_addToPath contains syntax
   *                                  errors
   */
   ...
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if p_queryString is not null and this
   ...
   *
   * @throws org.apache.xml.utils.URI.MalformedURIException if p_fragment is not null and this
   *                                  URI does not conform to the generic
   *                                  URI syntax or if the path is null
   */
